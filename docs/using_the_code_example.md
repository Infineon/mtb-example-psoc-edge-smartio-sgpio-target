...
The following example clones the "[Smart I/O SGPIO target](https://github.com/Infineon/mtb-example-psoc-edge-smartio-sgpio-target)" application with the desired name "SmartioSgpioTarget" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-smartio-sgpio-target --user-app-name SmartioSgpioTarget --target-dir "C:/mtb_projects"
   ```
